from python.AnalysisFunctions import Load_SePL, MakeCandidates, GetSentimentScores
...
sentence4 = 'Er kann nicht Auto fahren, er weiß nichts über usa, er traut sich nicht hinzufliegen, er hat kein toilettenpapier, er ist einfach zu schlecht , mies'
sentence5 = 'Es ist absolut nicht empfehlenswert, aber nicht nützlich'
...
candidates = MakeCandidates(sentence5, df_sepl, get='candidates')
negation_candidates = MakeCandidates(sentence5, df_sepl, get='negation')
...
sentimentscores, sepl_phrase = GetSentiments(candidates, df_sepl)

print('sentimentscores:', sentimentscores)
print('sepl_phrase:', sepl_phrase)
...
ProcessSentimentScores(sepl_phrase, negation_candidates, sentimentscores)
